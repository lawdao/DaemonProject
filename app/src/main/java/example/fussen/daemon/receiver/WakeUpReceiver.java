...
import example.fussen.daemon.service.DaemonService;
...
public class WakeUpReceiver extends BroadcastReceiver {
     ...
     */
    public static final String ACTION_CANCEL_JOB_ALARM_SUB = "com.fussen.daemon.CANCEL_JOB_ALARM_SUB";
    ...
    public static class WakeUpAutoStartReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            Log.d(TAG, "==========WakeUpAutoStartReceiver======Action:===" + intent.getAction());
            context.startService(new Intent(context, WorkService.class));
        }
    }
}
