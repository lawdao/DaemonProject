...
public class DaemonService extends Service {
    ...
    int onStart(Intent intent, int flags, int startId) {
        if (Build.VERSION.SDK_INT <= Build.VERSION_CODES.N) {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN_MR2)
                startService(new Intent(App.sApp, DaemonNotificationService.class));
        }
        ...
        sSubscription = Observable.interval(INTERVAL_WAKE_UP, TimeUnit.MILLISECONDS)
                .subscribe(new Action1<Long>() {
                    ...
                    public void call(Long aLong) {
                        ...
                        //=============本地记录日志=============
                        String content = "time: " + TimeUitl.parse(System.currentTimeMillis()) + "          =================守护进程开始定时检测================";
     ...
     * <p>
     * 因 DaemonService 运行在 :Daemon 子进程, 请勿在主进程中直接调用此方法.
    ...
    public static void cancelJobAlarmSub() {
        ...
        if (accountSubscription != null) accountSubscription.unsubscribe();
    }
    ...
    public static class DaemonNotificationService extends Service {
        ...
        @Override
        public int onStartCommand(Intent intent, int flags, int startId) {
            startForeground(DaemonService.HASH_CODE, new Notification());
            stopSelf();
            return START_STICKY;
        }
